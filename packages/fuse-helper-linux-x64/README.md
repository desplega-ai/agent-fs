...
Platform-specific FUSE helper binary for [@desplega.ai/agent-fs](https://www.npmjs.com/package/@desplega.ai/agent-fs). Do not install directly — it is automatically resolved via `optionalDependencies` when you install the main package on Linux x86_64.
